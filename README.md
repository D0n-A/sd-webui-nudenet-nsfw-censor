...
### Changelog
 ...
 - 20251211: add option to show "Enable" toggle in the main generation tab
...
- `Show "Enable" toggle in the main generation tab`: Adds an accordion to the main UI to toggle the censor per-generation (Requires Restart)
